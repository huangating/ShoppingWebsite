        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <!-- 这里是商品销售属性的地方 -->
              <dl
                  v-for="saleAttr in spuSaleAttrList" :key="saleAttr.id"
              ...
              >
                ...
                @click="changeChecked(saleAttrValue,
            ...
            <div class="cartWrap">
              ...
              <div class="add">
                <!-- 点击加入购物车按钮，不能用声明式导航，第一个：要发送请求、有业务 -->
...
// 通过辅助函数获取数据
  ...
  export default {
    ...
    mounted(){
      ...
      console.log("我是详情页的mounted，发送请求获取详情的数据");
    },
    computed:{
    ...
    methods:{
      ...
      // 数量的表单元素change回调
      handler(e){
        //  通过event事件对象获取用户输入内容【用户输入的内容如果是字符串类型的数据】
      ...
      async addOrUpdateCart(){
          try{
              ...
              // 路由跳转：携带参数，携带参数一般都是基本数据类型数据（字符串、数字等）
              // 浏览器存储功能：在路由跳转之前存储到浏览器中
